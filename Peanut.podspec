...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "ymsk" => "yamasaki-shun219@g.ecc.u-tokyo.ac.jp" }
  # Or just: spec.author    = "ymsk"
  # spec.authors            = { "ymsk" => "yamasaki-shun219@g.ecc.u-tokyo.ac.jp" }
  # spec.social_media_url   = "https://twitter.com/ymsk"
